...
export const generatedDiscoverySummary = {
  ...
  "warnings": [
    "Could not check Aurora Public Library volunteer opportunities: 500 Internal Server Error.",
    "Could not check Pickering Public Library technology events: 500 Internal Server Error.",
    "Could not check Oshawa Public Libraries STEM events: 500 Internal Server Error.",
